...
TEST_F(TarCreatorFixture, CreateUncompressedOfNothing)
{
    static constexpr int min_files {0};
    static constexpr int max_files {min_files};
    static constexpr int max_filesize {0};
...
TEST_F(TarCreatorFixture, CreateCompressedOfNothing)
{
    static constexpr int min_files {0};
    static constexpr int max_files {min_files};
    static constexpr int max_filesize {0};
